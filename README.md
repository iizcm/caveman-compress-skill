...
cp -r productivity/caveman-compress ~/.hermes/skills/productivity/caveman-compress/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/caveman-compress-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/caveman-compress-skill.git ~/.hermes/skills/productivity/caveman-compress/
```
...
```text
skill_view(name="productivity/caveman-compress")
```
...
```text
Use the caveman compress skill to <describe your specific task here>
```
...
```text
Gunakan skill caveman compress untuk <deskripsikan tugas spesifik Anda di sini>
```
